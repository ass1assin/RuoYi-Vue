<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="服务类别ID" prop="categoryId">
        <el-input
          v-model="queryParams.categoryId"
          placeholder="请输入服务类别ID"
          clearable
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="服务发布ID" align="center" prop="id" />
      <el-table-column label="发布用户ID" align="center" prop="userId" />
      <el-table-column label="服务类别ID" align="center" prop="categoryId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="服务类别ID" prop="categoryId">
          <el-input v-model="form.categoryId" placeholder="请输入服务类别ID" />
        </el-form-item>
        <el-form-item label="服务标题" prop="title">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        categoryId: [
          { required: true, message: "服务类别ID不能为空", trigger: "blur" }
        ],
        title: [
