    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['housekeeping:article:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['housekeeping:article:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
...
<script>
import { listArticle, getArticle, delArticle, addArticle, updateArticle } from "@/api/housekeeping/article";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('housekeeping/article/export', {
        ...this.queryParams
